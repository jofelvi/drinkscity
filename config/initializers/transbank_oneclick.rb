Transbank::Oneclick.configure do |config|
  ...
  if Rails.env.production?
    ...
    config.key_path          = Rails.root + "public/develop_oneclick/597044444405.key"
    config.cert_path         = Rails.root + "public/develop_oneclick/597044444405.crt"
    config.server_cert_path  = Rails.root + "public/develop_oneclick/tbk.pem.crt"
  end
