Transbank::Oneclick.configure do |config|
   config.url               = "https://webpay3gint.transbank.cl/webpayserver/wswebpay/OneClickPaymentService?wsdl"
   config.key_path          = Rails.root + "public/597044444405_ONECLICK/597044444405.key"
   config.cert_path         = Rails.root + "public/597044444405_ONECLICK/597044444405.crt"
   config.server_cert_path  = Rails.root + "public/597044444405_ONECLICK/tbk.pem.crt"
